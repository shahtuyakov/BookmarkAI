...
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "provider" varchar(20) DEFAULT 'email' NOT NULL;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "provider_id" varchar(255);--> statement-breakpoint
